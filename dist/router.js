...
async function router(req, res) {
    ...
    if (req.method === 'POST' && req.url === '/api/point-rules')
        return (0, pointRules_1.handleCreatePointRule)(req, res);
    if (req.method === 'GET' && req.url === '/api/point-rules')
        return (0, pointRules_1.handleListPointRules)(req, res);
    if (req.method === 'POST' && req.url === '/api/tier-rules')
        return (0, tierRules_1.handleCreateTierRule)(req, res);
    if (req.method === 'GET' && req.url === '/api/tier-rules')
